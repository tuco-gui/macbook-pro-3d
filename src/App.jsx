...
export default function App() {
  return (
    <div className="relative w-full h-screen bg-black font-mono">
      ...
      {/* 3D */}
      <Canvas camera={{ fov: 20, position: [0, -10, 180] }} gl={{ antialias: true, alpha: true }} className="!bg-transparent absolute inset-0">
        <Suspense
          fallback={
            <Html center>
        ...
        >
          {/* usa preset local, evita falha em HDRI externo */}
